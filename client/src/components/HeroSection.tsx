      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center justify-center min-h-[80vh] text-center">
          ...
          >
            ...
            <p className="text-3xl md:text-4xl text-black font-bold" style={{ fontFamily: 'Great Vibes, cursive', position: 'relative', top: '-5px', textShadow: '2px 2px 4px rgba(0,0,0,0.4)', filter: 'drop-shadow(2px 2px 3px rgba(0,0,0,0.3))' }}>Interior Design</p>
          </motion.div>
