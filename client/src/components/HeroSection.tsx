    ...
    <section id="home" className="relative min-h-screen py-16 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center justify-center min-h-[80vh] text-center">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold text-[#D9BF77]" style={{ fontFamily: 'Didot, "Didot LT STD", "Hoefler Text", Garamond, "Times New Roman", serif', fontWeight: 'bold', transform: 'scaleX(1.3)' }}>
              Ildikó Style
            </h1>
