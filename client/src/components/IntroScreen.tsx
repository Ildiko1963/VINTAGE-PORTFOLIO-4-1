      ...
      {isVisible && (
        ...
        >
          <div className="text-center">
            ...
            >
              <h1 className="text-3xl md:text-5xl font-bold text-[#D9BF77]" style={{ fontFamily: 'Didot, "Didot LT STD", "Hoefler Text", Garamond, "Times New Roman", serif', fontWeight: 'bold' }}>
                Ildikó Style
              </h1>
