      ...
      {isVisible && (
        ...
        >
          <div className="text-center">
            ...
            >
              <h1 className="text-3xl md:text-5xl font-bold text-[#D9BF77]" style={{ fontFamily: 'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }}>
                Ildikó Style
              </h1>
