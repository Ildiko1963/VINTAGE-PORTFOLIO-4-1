...
{t('about.title')}
          ...
          <div className="flex flex-col md:flex-row items-stretch gap-8 mb-12 md:ml-8">
            <motion.div 
              ...
              className="w-full md:w-[25%] flex items-start justify-center image-hover-container"
            >
            ...
            <motion.div 
              ...
              className="w-full md:w-[60%] font-lora relative md:pt-0 px-2 min-h-[480px] md:ml-16"
            >
